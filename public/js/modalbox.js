...
var MOOdalBox = {
	...
	position: function() {
		this.overlay.setStyles({top: Window.getScrollTop()+'px', height: (Window.getHeight() + 1)+'px'});
	},
	...
	nextEffect: function() {
		...
		case 3:
			this.bottom.setStyles({top: (this.top + 5)+'px', width: this.contents.style.width, marginLeft: this.center.style.marginLeft, display: ''});
